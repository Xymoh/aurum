...
export const HELP_CONTENT: Record<HelpGame, HelpContent> = {
  genshin: {
    ...
    intro: "giIntro",
    steps: [
      { text: "giStep1", image: "01-edit-profile.webp", capture: "giCapture1" },
      { text: "giStep2", image: "02-character-showcase.webp", capture: "giCapture2" },
      { text: "giStep3", image: "03-show-details.webp", capture: "giCapture3" },
    ],
  ...
  hsr: {
    ...
    intro: "hsrIntro",
    steps: [
      { text: "hsrStep1", image: "01-trailblazer-profile.webp", capture: "hsrCapture1" },
      { text: "hsrStep2", image: "02-character-showcase.webp", capture: "hsrCapture2" },
      { text: "hsrStep3", image: "03-make-public.webp", capture: "hsrCapture3" },
    ],
  ...
  zzz: {
    ...
    intro: "zzzIntro",
    steps: [
      { text: "zzzStep1", image: "01-profile.webp", capture: "zzzCapture1" },
      { text: "zzzStep2", image: "02-personal-homepage.webp", capture: "zzzCapture2" },
      { text: "zzzStep3", image: "03-make-info-public.webp", capture: "zzzCapture3" },
    ],
