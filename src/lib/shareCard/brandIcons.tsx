/**
 * Icons for the share dialog's action row.
 *
 * Kept apart from the shared stroke set in components/ui/icons: the X and
 * Discord marks are filled logos with their own geometry, and mixing them
 * into a set whose every glyph is a 2px stroke would invite someone to
 * "fix" them. Instagram's mark is an outline already, so it follows the
 * stroke convention.
 */
