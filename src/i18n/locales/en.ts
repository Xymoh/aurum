...
export const en = {
  ...
  explainer: {
    ...
    erP2:
      "So when a piece's ER is doing real work, it's flagged ER at risk with its own odds — the share of reshapes that would leave you short. That sits next to the reroll odds rather than being folded into them, because an ER requirement is one rough number per character and depends on your team: solo-Electro Flins wants far more than double-Electro Flins. Letting an approximation silently veto advice would be worse than showing you both numbers and trusting you to weigh them.",
    erP3:
