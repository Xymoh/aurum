...
export const en = {
  ...
  builds: {
    title: "Build guides",
    lead: "Weapons, sets, stats, teams, skills and materials for every character, with your own build alongside.",
    documentTitle: "Build guides - Aurum",
  ...
  guide: {
    ...
    build: "Build",
    weaponsGenshin: "Weapons",
    weaponsHsr: "Light Cones",
    weaponsZzz: "W-Engines",
    teams: "Teams",
    kit: "Skills",
    ...
    materials: "Materials",
    sources: "Sources",
    loading: "Loading the rest of the guide...",
    failed: "The rest of the guide could not be loaded. Reload the page to try again.",
    noPicks: "No guide covers {name} yet, so there are no weapon or team picks. The kit and materials come from the game itself.",
    equipped: "Equipped",
    equippedHint: "Your {name} is using this one",
    refinementHint: "Ranked at {label}",
    passive: "Passive",
    teamsLead: "Teams the guide recommends. Select a member to open their build.",
    synergies: "Strong partners",
    you: "{name}, this page",
    unknownMember: "A character this site does not list yet",
    or: "or",
    alternatives: "Alternatives to {name}: {names}",
    skillPriority: "Level-up priority",
    tracePriority: "Major trace priority",
    endgameStats: "Endgame stat targets",
    endgameStatsNote: "What a finished build reaches, as the guide states it.",
    endgameEnergyNote: "The score counts {target}% Energy Recharge as enough; reroll advice stops suggesting ER past it.",
    baseStats: "Base stats at Lv. {level}",
    bonusStatsGenshin: "Ascension stat",
    bonusStatsHsr: "Minor traces, total",
    bonusStatsZzz: "Core skill bonus",
    kitSkillsGenshin: "Combat talents",
    kitSkills: "Skills",
    kitPassives: "Passive talents",
    kitTraces: "Major traces",
    kitCore: "Core skill",
    scaling: "Scaling",
    level: "Level",
    levelShort: "Lv. {n}",
    matAscension: "Ascension, level 1 to {max}",
    matTalents: "All three talents, 1 to 10",
    matTraces: "Every skill and trace",
    matSkills: "All five skills to max",
    matCore: "Core skill to F",
    setBonus: "{n}-piece",
    setEffects: "Set effects",
    substatLineNote: "The guide's own wording, for comparison with the weights the score uses.",
    pickedFrom: "Picks from {site}, updated {date}",
    pickedFromUndated: "Picks from {site}",
    updatedOn: "updated {date}",
    behindKit: "{name}'s kit changed in a game update (noticed on {changed}), after this guide was last updated on {updated}. Its weapon, set and team picks may not reflect the change yet.",
    behindKitUndated: "{name}'s kit changed in a game update (noticed on {changed}), and this guide does not say when it was last updated. Its weapon, set and team picks may not reflect the change yet.",
    sourceWeights: "Stat weights and main stats",
    sourceSets: "Set picks",
    sourcePicks: "Weapon, team and priority picks",
    sourcePicksWithSets: "Set, weapon, team and priority picks",
    sourceGame: "Skill text and materials",
    sourceGameValue: "HoYoverse's game data, via {mirror}",
  },
