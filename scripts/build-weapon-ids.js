...
// The English game-text table, regenerated by fetch-enka-locale.js alongside
// the other languages. Same hash -> name shape as the old enka-locale.json.
const LOCALE_FILE = path.join(ROOT, "src", "data", "locales", "game-en.json");
...
async function main() {
  ...
  console.log(`  Loaded game-en.json (${Object.keys(locale).length} entries)`);
